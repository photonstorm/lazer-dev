...
/** This is just to appreciate performance **/
...
export default class ComputeVelocityGraphics {
    ...
    constructor() {
        ...
        for (let i = 0; i < bodies.length; ++i) {
            bodies[i] = Body(canvas.width / 2, canvas.height / 2, 4, 4);
        ...
        function loop() {
            ...
            for (let i = 0; i < bodies.length; ++i) {
                ctx.fillRect(bodies[i].position.x, bodies[i].position.y, 4, 4);
