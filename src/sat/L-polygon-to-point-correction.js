// SAT modules
import PolygonToCricleCorrection from 'sat/collision/PolygonToCircleCorrection.js'
...
export default class PolygonToPolygonCorrectionGraphics {
    ...
    constructor() {
        ...
        function loop() {
            ...
            if (PolygonToCricleCorrection(poly0, offset, 1, correctionData)) {
                ...
                ctx.fillRect(offset.x - correctionData.correction[0], offset.y - correctionData.correction[1], 20, 20);
            }
        }
        loop();
    }
