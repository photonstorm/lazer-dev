import PolyToPoly from 'sat/overlap/PolygonToPolygon.js'
...
console.log('poly0 overlap poly1 ? should be true', PolyToPoly(poly0, poly1));
console.log('poly1 overlap poly2 ? should be false', PolyToPoly(poly1, poly2));
